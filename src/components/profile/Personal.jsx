...
import { FaCaretDown, FaHandHoldingHeart, FaRoute } from "react-icons/fa6";
import { HiOutlineBanknotes, HiOutlineIdentification } from "react-icons/hi2";
...
import IdentityDocument from "./personal/IdentityDocument";
...
function Personal() {
  ...
  const initialValues = {
    ...
    contactNumber: profiles[0]?.contactNumber || "",
  ...
  return (
    <div
      class="purg7v1 purg7vc9 _15se5fi0 mn5ir73 mn5ir70 undefined"
      style={{ "--purg7v0": "transparent" }}
    >
      <div
        class="purg7v1 purg7v9v purg7vc9 _15se5fi0"
        style={{ "--purg7v0": "transparent" }}
      ></div>
        ...
        <div class="LmTK2 _3k5ae">
          <div class="_6o1-A">
            <div class="WToIY medium XOGJ7">
              ...
              >
                <div class="_6ILTG">
                  <AiOutlineUser size={35} color="#1F74EC" />
                </div>
              </div>
              <div class="Z2tZY">
                <span
                  ...
                  <Form class="tY4kP">
                    ...
                    <div id="generalInfo">
                                ...
                                >
                                  ...
                                  >
                                    <Field
                                      ...
                                      name="gender"
                                      value={
                                        values.gender || profiles[0]?.gender
                      ...
                      <div class="OV-fI zyPqg">
                        <div class="OnRSf">
                          {values && (values.dob || values.contactNumber) && (
                            <button
